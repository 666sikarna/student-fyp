...
-- Dumping data for table notes.questions: ~0 rows (approximately)
...
-- Dumping data for table notes.subject: ~0 rows (approximately)
...
-- Dumping data for table notes.uploads: 11 rows
...
-- Dumping data for table notes.users: 12 rows
...
-- Dumping data for table notes.user_note_list: 0 rows
/*!40000 ALTER TABLE `user_note_list` DISABLE KEYS */;
/*!40000 ALTER TABLE `user_note_list` ENABLE KEYS */;
...
-- Dumping data for table notes.videos: ~0 rows (approximately)
